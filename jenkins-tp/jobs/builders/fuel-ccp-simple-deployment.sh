...
export DOCKER_REGISTRY_HOST="registry-mcp.sandbox.mirantis.net"
export DOCKER_REGISTRY="${DOCKER_REGISTRY_HOST}:5000"
...
function deploy_ccp {
    ...
    ${SSH_COMMAND} "ccp -vvv --debug --config-file ~/ccp.yml deploy -c etcd memcached rabbitmq database"
