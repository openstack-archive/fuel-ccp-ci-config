...
export DOCKER_REGISTRY="registry-mcp.sandbox.mirantis.net:5000"
...
function ccp_install {
    ${SSH_COMMAND} "sudo pip install -r fuel-ccp/requirements.txt"
    ${SSH_COMMAND} "sudo pip install fuel-ccp/"
}
