...
# CONFIGURATION:
######################################################
FUEL_DEVOPS_ENV_NAME="ccp-deployment-env-${ENV_ID}"
...
(
flock -n 30 || exit 1
echo  "1" > /home/jenkins/workspace/lock1
export ENV_ID="A"
build
) 30>/home/jenkins/workspace/lockfile1

(
flock -n 40 || exit 1
echo  "1" > /home/jenkins/workspace/lock2
export ENV_ID="B"
build
) 40>/home/jenkins/workspace/lockfile2

(
flock -n 50 || exit 1
echo  "1" > /home/jenkins/workspace/lock3
export ENV_ID="C"
build
) 50>/home/jenkins/workspace/lockfile3
